...
SAT_TweenNode::SAT_TweenNode(void* ATarget, uint32_t AId, double ADuration, uint32_t AType, uint32_t ANumValues=0, double* AStartValues=nullptr, double* AEndValues=nullptr, uint32_t ATween=0) {
    //SAT_TRACE;
    MType         = AType;
    MId           = AId;
    MDuration     = ADuration;
...
// void SAT_Tweening::appendTween(SAT_TweenNode* ATween)
// {
//     // create chain
//     // append node
// }
  
SAT_TweenChain* SAT_Tweening::appendChain(SAT_TweenChain* AChain)
{
...
void SAT_Tweening::deleteChains()
{
...
void SAT_Tweening::process(double ADelta)
{
    // SAT_TRACE;
