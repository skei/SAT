...
double SAT_RandomSystem::valueSigned()
{
    double r = (double)rand() * (double)SAT_INVRANDMAX; // / (double)RAND_MAX;
    return r * 2.0f - 1.0f;
}
...
double SAT_RandomSystem::valueRange(double minval, double maxval)
{
    return minval + (value() * (maxval - minval) );
}

int32_t SAT_RandomSystem::valueInt()
{
    return rand(); // & 0x7fffffff;
}
...
int32_t SAT_RandomSystem::valueSignedInt()
{
    return rand();
}
...
int32_t SAT_RandomSystem::valueRangeInt(int32_t minval, int32_t maxval)
{
    int32_t range = maxval-minval+1;
    if (range <= 0) return minval;
    //else return minval + SModulo(SAT_RandomInt(),range);
...
SAT_RandomLCG::SAT_RandomLCG(uint32_t ASeed)
{
    rand_lcg_seed = ASeed;
}

void SAT_RandomLCG::seed(uint32_t ASeed)
{
    rand_lcg_seed = ASeed;
}

double SAT_RandomLCG::value()
{
    double result = (double)rand_lcg() * (double)SAT_INVRANDMAX;
    return abs(result);
}

double SAT_RandomLCG::valueSigned()
{
    double result = (double)rand_lcg();
    result *= (double)SAT_INVRANDMAX;
    //return result * 2.0f - 1.0f;
...
double SAT_RandomLCG::valueRange(double minval, double maxval)
{
    return minval + (value() * (maxval - minval) );
}

int32_t SAT_RandomLCG::valueInt()
{
    //return rand_lcg();// & 0x7fffffff;
    return abs(rand_lcg());
}
...
int32_t SAT_RandomLCG::valueSignedInt()
{
    return rand_lcg();
}
...
int32_t SAT_RandomLCG::valueRangeInt(int32_t minval, int32_t maxval)
{
    int32_t range = maxval - minval + 1;
    if (range <= 0) return minval;
    //else return minval + SModulo(SAT_RandomInt(),range);
...
int32_t SAT_RandomLCG::rand_lcg()
{
    //rand_lcg_seed = ((uint64_t)rand_lcg_seed * 279470273UL) % 4294967291UL;
    //return (int32_t)rand_lcg_seed;
    uint64_t v = (uint64_t)rand_lcg_seed * 279470273UL;
