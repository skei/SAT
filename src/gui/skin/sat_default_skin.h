...
: SAT_DefaultPanelSkin()
{
    ...
    setBackgroundColor(SAT_Color(0.45, 0.45, 0.45), SAT_SKIN_STATE_HIGHLIGHTED | SAT_SKIN_STATE_HOVERING, SAT_SKIN_MODE_MATCH);

    setBorderColor(SAT_Color(0.40, 0.40, 0.40));
    setBorderColor(SAT_Color(0.45, 0.45, 0.45), SAT_SKIN_STATE_HOVERING, SAT_SKIN_MODE_MATCH);
    setBorderColor(SAT_Color(0.50, 0.50, 0.50), SAT_SKIN_STATE_HIGHLIGHTED, SAT_SKIN_MODE_MATCH);
    setBorderColor(SAT_Color(0.55, 0.55, 0.55), SAT_SKIN_STATE_HIGHLIGHTED | SAT_SKIN_STATE_HOVERING, SAT_SKIN_MODE_MATCH);

    setTextColor(SAT_Color(0.70, 0.70, 0.70), SAT_SKIN_STATE_HOVERING, SAT_SKIN_MODE_MATCH);
    setTextColor(SAT_Color(0.80, 0.80, 0.80), SAT_SKIN_STATE_HIGHLIGHTED, SAT_SKIN_MODE_MATCH);
    setTextColor(SAT_Color(0.90, 0.90, 0.90), SAT_SKIN_STATE_HIGHLIGHTED | SAT_SKIN_STATE_HOVERING, SAT_SKIN_MODE_MATCH);
}
